...
@Component
@NoArgsConstructor
public class CloneReturnExceptionDAO extends AbstractObjectFactory<SettingReturnExceptions> {
    private static Logger logger = LoggerFactory.getLogger(CloneReturnExceptionDAO.class);
    private static final String SQL_CALL_NAME = " { call test_setting.clone_setting_return_exception(?) } ";
    ...
    public SettingReturnExceptions getObject(Map<String, Object> params) {
        ...
        try {
            ...
            logger.debug("Get info for clone: {}", params + ": " + settingReturnExceptions);
