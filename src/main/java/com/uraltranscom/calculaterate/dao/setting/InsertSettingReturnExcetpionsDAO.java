...
@Component
@NoArgsConstructor
public class InsertSettingReturnExcetpionsDAO extends ConnectionDB {
    private static Logger logger = LoggerFactory.getLogger(InsertSettingReturnExcetpionsDAO.class);
