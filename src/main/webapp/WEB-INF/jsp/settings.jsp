            ...
            <c:forEach items="${mapReturnStations}" var="total">
              <c:forEach items="${total.value}" var="setting">
                <tr id="contReturnStation${setting.getId()}">
                  ...
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="roadReturnStationSetting${setting.getId()}" value='${total.key}' onkeyup="search(this.id)" onclick="cleanField(event)" />
                  ...
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="stationReturnStation${setting.getId()}" value='${setting.getNameStationReturn()}' onkeyup="search(this.id)" onclick="cleanField(event)" />
                      <span class="focus-border"></span></div>
                  </td>
            ...
            <c:forEach items="${mapReturnExceptions}" var="total">
              <c:forEach items="${total.value}" var="setting">
                <tr id="contReturnException${setting.getId()}">
                  ...
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="roadReturnExceptionSetting${setting.getId()}" value='${total.key}' onkeyup="search(this.id)" onclick="cleanField(event)" />
                      <span class="focus-border"></span></div>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="stationFromReturnException${setting.getId()}" value='${setting.getStationFrom().getNameStation()}' onkeyup="search(this.id)" onclick="cleanField(event)" /><span class="focus-border"></span></div>
                  </td>
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="stationToReturnException${setting.getId()}" value='${setting.getStationTo().getNameStation()}' onkeyup="search(this.id)" onclick="cleanField(event)" /><span class="focus-border"></span></div>
                  </td>
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="cargoReturnException${setting.getId()}" value='${setting.getCargo().getNameCargo()}' onkeyup="search(this.id)" onclick="cleanField(event)" /><span class="focus-border"></span></div>
                  </td>
                  <td>
                    <div class="col-3__list">
                      <div class="wrapper">
            ...
            <c:forEach items="${mapBeginningExceptions}" var="total">
              <c:forEach items="${total.value}" var="setting">
                <tr id="contBeginningException${setting.getId()}">
                  ...
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="roadBeginningExceptionSetting${setting.getId()}" value='${total.key}' onkeyup="search(this.id)" onclick="cleanField(event)" />
                      <span class="focus-border"></span></div>
                  </td>
                  <td>
                  ...
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="stationFromBeginningException${setting.getId()}" value='${setting.getStationFrom().getNameStation()}' onkeyup="search(this.id)" onclick="cleanField(event)" /><span class="focus-border"></span></div>
                  </td>
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="stationToBeginningException${setting.getId()}" value='${setting.getStationTo().getNameStation()}' onkeyup="search(this.id)" onclick="cleanField(event)" /><span class="focus-border"></span></div>
                  </td>
                  <td>
                    <div class="col-3"><input class="effect-1" type="text" autocomplete="off" id="cargoBeginningException${setting.getId()}" value='${setting.getCargo().getNameCargo()}' onkeyup="search(this.id)" onclick="cleanField(event)" /><span class="focus-border"></span></div>
                  </td>
                  <td>
                    <div class="col-3__list">
                      <div class="wrapper">
